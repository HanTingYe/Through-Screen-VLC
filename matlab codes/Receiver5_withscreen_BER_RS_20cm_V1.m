...
load Results_RS_8CSK_15_20cm_13.mat
...
%30cm
% CSK_x = [0.375,0.2,0.3889,0.2308,0.4375,0.3077,0.2105,0.5764];
% CSK_y = [0.5,0.5333,0.3889,0.3846,0.3125,0.2308,0.1053,0.3179];
...
CSK_x_underscreen = [0.639, 0.635, 0.645, 0.635, 0.651, 0.64, 0.616, 0.66];%647
CSK_y_underscreen = [0.324, 0.319, 0.312, 0.308, 0.302, 0.298, 0.283, 0.31];%303
T_screen=diff(symbol_Txscreen_index);
