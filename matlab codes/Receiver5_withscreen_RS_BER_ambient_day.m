...
count=20;
color='Results_RS_8CSK_ambient_day_31_';
...
%night
% CSK_x = [0.356,0.256,0.386,0.242,0.444,0.313,0.208,0.620];
% CSK_y = [0.534,0.513,0.386,0.364,0.305,0.239,0.125,0.324];

%daytime
% CSK_x = [0.353,0.328,0.363,0.320,0.382,0.342,0.310,0.428];
% CSK_y = [0.422,0.406,0.385,0.380,0.364,0.352,0.323,0.366];

%daytime V2
CSK_x = [0.325,0.283,0.348,0.257,0.389,0.293,0.229,0.531];
CSK_y = [0.5125,0.472,0.391,0.365,0.319,0.267,0.181,0.344];

% CSK_x_screen = 0.654400000000000;
% CSK_y_screen = 0.320500000000000;
CSK_x_screen = 0.642;%0.665 0.655
CSK_y_screen = 0.321;%0.3 0.31
symbol=[];
for ii=1:length_min
    delta_d=[];
    for jj=1:M
...
%night
% CSK_x_underscreen = [0.593, 0.609, 0.601, 0.586, 0.608, 0.591, 0.575, 0.642];
% CSK_y_underscreen = [0.360, 0.339, 0.332, 0.326, 0.316, 0.306, 0.286, 0.321];

%daytime
CSK_x_underscreen = [0.585, 0.595, 0.595, 0.578, 0.600, 0.582, 0.567, 0.625];
CSK_y_underscreen = [0.357, 0.343, 0.331, 0.328, 0.321, 0.313, 0.294, 0.324];
