...
load Results_RS_original8CSK_31_5.mat
premble_index=0;
...
%red screen
CSK_x = [0.1690,0.1636,0.5072,0.3278,0.4285,0.6329,0.2273,0.1419];
CSK_y = [0.7042,0.4909,0.3333,0.5737,0.2207,0.3291,0.2121,0.0774];
% CSK_x_screen = 0.654400000000000;
% CSK_y_screen = 0.320500000000000;
CSK_x_screen = 0.6491;%0.665, 0.655
CSK_y_screen = 0.3193;%0.3, 0.31
symbol=[];
for ii=1:length_min
    delta_d=[];
    for jj=1:M
...
%red screen
CSK_x_underscreen = [0.5574, 0.5771, 0.6236, 0.5944, 0.6048, 0.6491, 0.5738, 0.4745];
CSK_y_underscreen = [0.3934, 0.3457, 0.3214, 0.3639, 0.3011, 0.3193, 0.3005, 0.2350];
...
for ii=1:length(symbol_Txscreen_index)
    ...
    if sqrt((x(symbol_Txscreen_index(ii))-CSK_x_screen)^2+(y(symbol_Txscreen_index(ii))-CSK_y_screen)^2)>Slope_threshold
        ...
        case 4
            symbol_received(symbol_Txscreen_index(ii)) = 2;
        case 5
            symbol_received(symbol_Txscreen_index(ii)) = 6;% Note that symbol 7 is screen color
        case 7
            symbol_received(symbol_Txscreen_index(ii)) = 5;
        case 8
            symbol_received(symbol_Txscreen_index(ii)) = 4;
