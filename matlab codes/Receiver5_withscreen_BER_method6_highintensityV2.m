...
load Results_8CSK_displayall_2.mat
...
%% search for premble
premble_flag=0;
premble_number = 24; %4 for 500us; 8 for 1ms
...
plotChromaticity
hold on
scatter(x(symbol_index(1:100)),y(symbol_index(1:100)),48,'black');

figure(9)
plotChromaticity
hold on
scatter(x(symbol_index(1:1000)),y(symbol_index(1:1000)),48,'black');
