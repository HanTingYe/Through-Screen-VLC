...
count=1;
color='Test_TX_OPT101_250_15_';%TX_OPT101
save([color num2str(count)]);
% save('Calibration_abnormalscreenred3_blue');


% color='Section3_onlyscreen_intensity_31_';
% save([color num2str(interval)]);
delete (s);

for i=0:length(data)-1
    DATA=  [DATA,abs(data(i+1))]%所以在Arduino程序里要使用Serial.println()
end
