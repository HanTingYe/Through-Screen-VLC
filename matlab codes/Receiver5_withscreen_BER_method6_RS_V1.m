...
%  CSK_x = [0.349,0.188,0.412,0.219,0.487,0.303,0.167,0.625];
%  CSK_y = [0.535,0.594,0.412,0.375,0.297,0.212,0.074,0.325];
 
%  CSK_x = [0.362,0.192,0.4,0.21,0.458,0.296,0.164,0.657];
%  CSK_y = [0.534,0.538,0.36,0.34,0.288,0.204,0.082,0.311];
