...
screen_threshold=11500;%mean(X(premble_index:length_min))
...
for ii=premble_index:length_min
    if count_flag == flag_position %   3 for 1ms
        if ~(ismember(ii,symbol_Txscreen_index))
