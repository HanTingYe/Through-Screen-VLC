%% This version suited for slope detection when screen intensity equals to 31 11000 0.231
clc
clear
close all
%%

load Test_screen_intensity_141.mat
...
screen_threshold=11000;%mean(X(premble_index:length_min))
