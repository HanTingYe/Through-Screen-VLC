...
load Test_screen_intensity_12.mat
...
for i=1:length(premble_location)-2
    if premble_location(i+1)-premble_location(i)==1 || premble_location(i+1)-premble_location(i)==2 || premble_location(i+1)-premble_location(i)==3 || premble_location(i+1)-premble_location(i)==4
