...
count=2;
color='Results_RS_original4CSK_15_whitescreen_v2_';
...
%whitescreen
CSK_x_underscreen = [0.3503, 0.3399, 0.3813, 0.3114];
CSK_y_underscreen = [0.3757, 0.4043, 0.3723, 0.3174];
T_screen=diff(symbol_Txscreen_index);
...
%% search for premble
premble_flag=0;
premble_number = 12; %4 for 500us; 8 for 1ms; 24 for intensity 31
