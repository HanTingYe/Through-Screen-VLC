...
load Results_RS_original8CSK_15_10d1.mat
...
%20 degree
% CSK_x = [0.25,0.215,0.259,0.202,0.296,0.210,0.138,0.64];
% CSK_y = [0.658,0.646,0.519,0.494,0.370,0.290,0.107,0.28];

%10 degree
CSK_x = [0.312,0.2,0.344,0.2,0.418,0.274,0.164,0.66];
CSK_y = [0.584,0.6,0.426,0.417,0.309,0.235,0.091,0.3];
...
%20 degree
% CSK_x_underscreen = [0.543, 0.577, 0.576, 0.551, 0.597, 0.575, 0.558, 0.643];
% CSK_y_underscreen = [0.412, 0.377, 0.362, 0.361, 0.333, 0.321, 0.291, 0.321];

%10 degree
CSK_x_underscreen = [0.581, 0.6, 0.598, 0.576, 0.610, 0.593, 0.573, 0.643];
CSK_y_underscreen = [0.377, 0.355, 0.343, 0.341, 0.325, 0.315, 0.293, 0.323];
...
%find(abs(bit_received_recovered_RS(1:1000)-bit_original(1:1000))~=0)
%%
