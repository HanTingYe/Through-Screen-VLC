...
load Results_RS_8CSK_ambient_15_13.mat
...
%night V2 16 Gain
% CSK_x = [0.37,0.25,0.36,0.26,0.45,0.35,0.22,0.64];
% CSK_y = [0.519,0.5,0.41,0.37,0.32,0.25,0.11,0.32];
...
%night V2
% CSK_x_underscreen = [0.588, 0.6, 0.595, 0.573, 0.605, 0.590, 0.571, 0.639];
% CSK_y_underscreen = [0.363, 0.345, 0.333, 0.330, 0.316, 0.305, 0.286, 0.319];
