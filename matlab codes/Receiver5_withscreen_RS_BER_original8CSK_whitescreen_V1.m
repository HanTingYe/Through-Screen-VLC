...
load Results_RS_original8CSK_31_whitescreen_12.mat
premble_index=1106;
...
M = 8;
%V1
% CSK_x = [0.1864,0.1724,0.4918,0.3276,0.4058,0.6406,0.2407,0.1465];
% CSK_y = [0.6610,0.5,0.3279,0.5689,0.2029,0.3281,0.2037,0.07];

%V2
% CSK_x = [0.1923,0.1818,0.4808,0.3148,0.4,0.6481,0.2407,0.1634];
% CSK_y = [0.6731,0.4909,0.3269,0.5741,0.2,0.3148,0.2037,0.0784];


%white screen
CSK_x = [0.18,0.1818,0.4681,0.2979,0.3833,0.6667,0.2222,0.1647];
CSK_y = [0.66,0.4545,0.2979,0.5745,0.1667,0.2889,0.1852,0.0765];
...
% CSK_x_underscreen = [0.3977, 0.3962, 0.4389, 0.4156, 0.4272, 0.4609, 0.3511, 0.3415];
% CSK_y_underscreen = [0.5511, 0.5256, 0.5, 0.5379, 0.4821, 0.5024, 0.3964, 0.375];

%whitescreen
CSK_x_underscreen = [0.3378, 0.3362, 0.3619, 0.3483, 0.3542, 0.3778, 0.3402, 0.3060];
CSK_y_underscreen = [0.4030, 0.3859, 0.3724, 0.3948, 0.3576, 0.3726, 0.3608, 0.3060];
T_screen=diff(symbol_Txscreen_index);
...
premble_location=find(symbol_received==7)
