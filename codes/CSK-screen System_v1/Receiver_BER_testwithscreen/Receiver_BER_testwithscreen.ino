...
int Number = 100; //The number of symbols
...
//Measure ouput
uint16_t x_data[100] = {0};
uint16_t y_data[100] = {0};
uint16_t z_data[100] = {0};
...
void loop() {
  ...
  //total time:10821653 us; for loop time: 10821251; oneloop time: 63 us;
  if (count > Number) {
