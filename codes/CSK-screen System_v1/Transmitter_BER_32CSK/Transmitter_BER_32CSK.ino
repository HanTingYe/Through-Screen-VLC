...
void setup() {
  ...
  while (Tx_unit < M)
  {
    ...
    cnt_unit = bitadd32(cnt_unit, temp[3], temp[4], temp[5], temp[6], temp[7]);
    Tx_unit++;
  }
...
void loop() {
  ...
  TxStr = bytesStr.substring(bit_count, (bit_count + 5));
  Tx = TxStr.toInt();
  switch (Tx)
  {
    case 0: setColor(CSK0_R_32, CSK0_G_32, CSK0_B_32); break;
    case 1: setColor(CSK1_R_32, CSK1_G_32, CSK1_B_32); break;
    case 10: setColor(CSK2_R_32, CSK2_G_32, CSK2_B_32); break;
    case 11: setColor(CSK3_R_32, CSK3_G_32, CSK3_B_32); break;
    case 100: setColor(CSK4_R_32, CSK4_G_32, CSK4_B_32); break;
    case 101: setColor(CSK5_R_32, CSK5_G_32, CSK5_B_32); break;
    case 110: setColor(CSK6_R_32, CSK6_G_32, CSK6_B_32); break;
    case 111: setColor(CSK7_R_32, CSK7_G_32, CSK7_B_32); break;
    case 1000: setColor(CSK8_R_32, CSK8_G_32, CSK8_B_32); break;
    case 1001: setColor(CSK9_R_32, CSK9_G_32, CSK9_B_32); break;
    case 1010: setColor(CSK10_R_32, CSK10_G_32, CSK10_B_32); break;
    case 1011: setColor(CSK11_R_32, CSK11_G_32, CSK11_B_32); break;
    case 1100: setColor(CSK12_R_32, CSK12_G_32, CSK12_B_32); break;
    case 1101: setColor(CSK13_R_32, CSK13_G_32, CSK13_B_32); break;
    case 1110: setColor(CSK14_R_32, CSK14_G_32, CSK14_B_32); break;
    case 1111: setColor(CSK15_R_32, CSK15_G_32, CSK15_B_32); break;
    case 10000: setColor(CSK16_R_32, CSK16_G_32, CSK16_B_32); break;
    case 10001: setColor(CSK17_R_32, CSK17_G_32, CSK17_B_32); break;
    case 10010: setColor(CSK18_R_32, CSK18_G_32, CSK18_B_32); break;
    case 10011: setColor(CSK19_R_32, CSK19_G_32, CSK19_B_32); break;
    case 10100: setColor(CSK20_R_32, CSK20_G_32, CSK20_B_32); break;
    case 10101: setColor(CSK21_R_32, CSK21_G_32, CSK21_B_32); break;
    case 10110: setColor(CSK22_R_32, CSK22_G_32, CSK22_B_32); break;
    case 10111: setColor(CSK23_R_32, CSK23_G_32, CSK23_B_32); break;
    case 11000: setColor(CSK24_R_32, CSK24_G_32, CSK24_B_32); break;
    case 11001: setColor(CSK25_R_32, CSK25_G_32, CSK25_B_32); break;
    case 11010: setColor(CSK26_R_32, CSK26_G_32, CSK26_B_32); break;
    case 11011: setColor(CSK27_R_32, CSK27_G_32, CSK27_B_32); break;
    case 11100: setColor(CSK28_R_32, CSK28_G_32, CSK28_B_32); break;
    case 11101: setColor(CSK29_R_32, CSK29_G_32, CSK29_B_32); break;
    case 11110: setColor(CSK30_R_32, CSK30_G_32, CSK30_B_32); break;
    case 11111: setColor(CSK31_R_32, CSK31_G_32, CSK31_B_32); break;
  }
