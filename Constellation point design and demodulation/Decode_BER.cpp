...
/*   int data_unit[] = {5, 57, 119};
  ...
  message_unit[1] =  (char) b;
  message_unit[2] =  (char) c;
  message_unit[3] =  (char) a;
  message_unit[4] =  (char) b;
  message_unit[5] =  (char) c;
  message_unit[6] =  (char) a;
  message_unit[7] =  (char) b;
  message_unit[8] =  (char) c;
  message_unit[9] =  (char) a;
  message_unit[10] =  (char) b;
  message_unit[11] =  (char) c;
