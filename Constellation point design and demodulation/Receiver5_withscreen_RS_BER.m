...
BER_CSK=sum(abs(bit_received_recovered_RS(1:length(bit_received_recovered_RS))-bit_original(1:length(bit_received_recovered_RS))))/(length(bit_received_recovered_RS))
