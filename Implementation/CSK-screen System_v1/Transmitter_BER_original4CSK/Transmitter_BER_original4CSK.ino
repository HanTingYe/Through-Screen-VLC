...
boolean *bitadd4(boolean *p, boolean a, boolean b)
{
  *p++ = a;
  *p++ = b;
  return (p);
...
void setup() {
  ...
  while (Tx_unit < 4)
  {
    switch (Tx_unit)
    {
      case 0: cnt_unit = bitadd4(cnt_unit, 0, 0); break;
      case 1: cnt_unit = bitadd4(cnt_unit, 0, 1); break;
      case 2: cnt_unit = bitadd4(cnt_unit, 1, 0); break;
      case 3: cnt_unit = bitadd4(cnt_unit, 1, 1); break;
    }
...
void loop() {
  ...
  TxStr = bytesStr.substring(bit_count, (bit_count + 2));
  Tx = TxStr.toInt();
  switch (Tx)
  {
    case 0: setColor(CSK0_R_ori4, CSK0_G_ori4, CSK0_B_ori4); break;
    case 1: setColor(CSK1_R_ori4, CSK1_G_ori4, CSK1_B_ori4); break;
    case 10: setColor(CSK2_R_ori4, CSK2_G_ori4, CSK2_B_ori4); break;
    case 11: setColor(CSK3_R_ori4, CSK3_G_ori4, CSK3_B_ori4); break;
  }
